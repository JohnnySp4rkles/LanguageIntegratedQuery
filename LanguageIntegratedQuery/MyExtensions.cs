...
namespace LanguageIntegratedQuery
{
    public static class MyExtensions
    {
        ...
        public static IEnumerable<IGrouping<TKey, TSource>> ChunkBy<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, IEqualityComparer<TKey> comparer)
        {
            ...
            while (true)
            {
                ...
                // returned only when the client code foreach's over this chunk. See Chunk.GetEnumerator for more info.                yield return current;
    ...
    {        // The source sequence.
        ...
        private static IEnumerable<IGrouping<string, KeyValPair>> query;
